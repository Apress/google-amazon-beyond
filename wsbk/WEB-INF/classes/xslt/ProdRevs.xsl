...
<!--
  This stylesheet displays a set of Product Reviews, e.g.
   http://localhost:65432/ProdRevs/0393011836?xslt=ProdRevs.xsl
...
<!-- top-level match -->
<xsl:template match="/">
  <html><head><title>ProdRevs.xsl</title></head>
    <body>
...
<xsl:template match="table">
  <xsl:variable name="asin" select="tr[2]/td[2]"/>
  <xsl:if test="$asin">
