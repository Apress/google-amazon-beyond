...
public class TidyFilter implements Filter {
...
public void init(FilterConfig filterConfig)throws ServletException{
  ...
  ctx.log("Filter "+filterConfig.getFilterName()+"; map webapps/"+srcPrefix+" to "+ctx.getRealPath(targetPrefix));
}
...
public void doFilter(javax.servlet.ServletRequest servletRequest,
  ...
  filterChain.doFilter(servletRequest,wrappedResp); // pass it through
...
public String cleanUpFile(String srcFileName,String targetFileName){
  ...
  try{
    ...
    return "";
    }catch(Exception ex){ctx.log("cleanUpFile err: ",ex); return "err: "+ex;}
}
